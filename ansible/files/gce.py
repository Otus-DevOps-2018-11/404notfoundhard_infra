...
class GceInventory(object):
    ...
    def get_config(self):
        ...
        config = configparser.SafeConfigParser(defaults={
            'gce_service_account_email_address': 'libcloud@infra-201811.iam.gserviceaccount.com',
            'gce_service_account_pem_file_path': '/home/notfound/1OTUS/404notfoundhard_infra/ansible/files/secret.secret',
            'gce_project_id': 'infra-201811',
            'gce_zone': '',
            'libcloud_secrets': '',
            'instance_tags': '',
            'inventory_ip_type': '',
